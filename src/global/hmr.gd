# Thanks to https://github.com/KoBeWi/Godot-Directory-Watcher
extends Node
class_name Watcher
...
## список на удаление из директорий, нужен что бы избежать мутаций в коде
...
func _ready() -> void:
	...
	_remaining_steps = scan_files_count
